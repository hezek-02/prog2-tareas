...
/*
  Devuelve 'true' si y solo si 'natural' es el componente natural 
  de algún elemento de 'cad'.
 */
...
/*
  Devuelve el primer elemento de 'cad' cuyo componente 
  natural es 'natural'.
...
/*
  Remueve el primer elemento de 'cad' cuyo componente natural
  es 'natural'.
  Los demás elementos de 'cad' mantienen su orden relativo.
