...
/*
  Devuelve un arreglo de caracteres formado por la 
  concatenación del componente
  natural  de 'info', el string "," y el componente real  
  de 'info' encerrados
  entre parentesis.
  El elemento devuelto no comparte memoria con 'info'.
  Termina con '\0'.
...
/*
  ...
  Se asume que la antrada cumple con el formato descrito en 
  'infoATexto' del
  módulo 'info''.
 */
TInfo leerInfo();
